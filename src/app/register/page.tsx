      ...
      <div className="hidden lg:flex lg:w-1/2 animated-gradient items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-white max-w-md">
          ...
          <p className="text-white/80 text-lg leading-relaxed">
            Create your account and start managing tasks like a pro. Your first account becomes the admin!
          </p>
          <div className="mt-12 space-y-4">
            {["Instant setup — no credit card", "First user gets admin access", "Invite your team members"].map((item) => (
